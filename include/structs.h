...
struct struct000 {
    ...
    /* 0x300 */ Energy energy[2];
    /* 0x308 */ u8  pad308[0x1A];
    /* 0x322 */ s16 unk322;
...
typedef struct {
    ...
    /* 0x312 */ s16 unk314;
    /* 0x312 */ u8  pad316[0xC];
    /* 0x322 */ s16 unk322; // SSSV 0x302 (heading)
    /* 0x324 */ s16 unk324; // SSSV 0x304 (previousHeading)
    /* 0x326 */ u8  pad326[0x2];
    /* 0x328 */ s16 unk328;
    /* 0x32A */ s16 unk32A;
    /* 0x32C */ s16 unk32C;
